...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    protected static final int ORG_VIDEO_DEGREE = 80031;
    //----------------------------------------
    // options
    ...
    public void prestartInsertVideo(String path, String fileName, int width, int height)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        _prestartInsertVideo(path, fileName, width, height);
    }

    private native void _prestartInsertVideo(String path, String fileName, int width, int height)
            throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;

    @Override
    public void startInsertVideo(int width, int height, int pix_fmt) throws IllegalStateException {
        _startInsertVideo(width, height, pix_fmt);
    }

    private native void _startInsertVideo(int width, int height, int pix_fmt)
            throws IllegalStateException;

    @Override
    public void insertVideoData(byte[] data, int align, boolean copy) throws IllegalStateException {
        _insertVideoData(data, data.length, align, copy);
    }

    private native void _insertVideoData(byte[] data, int data_size, int align, boolean copy)
            throws IllegalStateException;
    ...
    @Override
    public void setOutputVideo(boolean enable) throws IllegalStateException {
        _setOutputVideo(enable);
    }

    private native void _setOutputVideo(boolean enable) throws IllegalStateException;

    public void setOutputOriginalVideo(boolean enable) throws IllegalStateException {
        _setOutputOriginalVideo(enable);
    }

    private native void _setOutputOriginalVideo(boolean enable) throws IllegalStateException;
    ...
    public boolean setStretchedVrMode(boolean vrMode, boolean stretched) throws IllegalStateException {
        return _setStretchedVrMode(vrMode, stretched);
    }

    private native boolean _setStretchedVrMode(boolean vrMode, boolean stretched)
            throws IllegalStateException;

    @Override
    public boolean setRotation180(boolean rotation180) throws IllegalStateException {
        setVideoFilterRotate180(rotation180);
        return true;
    }
    ...
    public void setVideoFilter(String nodeName, String filterName, String filterArg, boolean enable)
            throws IllegalStateException {
        _setVideoFilter(nodeName, filterName, filterArg, enable);
    }

    private native void _setVideoFilter(String nodeName, String filterName, String filterArg, boolean enable)
            throws IllegalStateException;

    public void setVideoFilterRotate(int degree, boolean enable) throws IllegalStateException {
        _setVideoFilterRotate(degree, enable);
    }

    private native void _setVideoFilterRotate(int degree, boolean enable) throws IllegalStateException;

    public void setVideoFilterTranspose(String dir, boolean enable) throws IllegalStateException {
        _setVideoFilterTranspose(dir, enable);
    }

    private native void _setVideoFilterTranspose(String dir, boolean enable) throws IllegalStateException;

    public void setVideoFilterRotate180(boolean enable) throws IllegalStateException {
        _setVideoFilterRotate180(enable);
    }

    private native void _setVideoFilterRotate180(boolean enable) throws IllegalStateException;
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case INS_VIDEO_STATE:
                player.notifyOnInsertVideo(msg.arg1);
                break;

            case OUT_VIDEO_STATE:
                if (msg.obj != null) {
                    int width_height_pixfmt = msg.arg1;
                    int width = (width_height_pixfmt & 0xFFF) << 1;
                    int height = ((width_height_pixfmt >> 12) & 0x7FF) << 1;
                    int pix_fmt = (width_height_pixfmt >> 23) & 0x1FF;
                    player.notifyOnReceivedFrame((byte[])msg.obj, width, height, pix_fmt);
                }
                break;

                case ORG_VIDEO_STATE:
                    if (msg.obj != null) {
                        int width_height_pixfmt_id = msg.arg1;
                        int degree = msg.arg2;
                      //  Log.e("arsen","data is comingwidth_height_pixfmt_id"+width_height_pixfmt_id);
                        int width = (width_height_pixfmt_id & 0x3FF) << 1;
                        int height = ((width_height_pixfmt_id >> 10) & 0x3FF) << 1;
                        int pix_fmt = (width_height_pixfmt_id >> 20) & 0x1FF;
                        int video_id = (width_height_pixfmt_id >> 29) & 0x7;
                        player.notifyOnReceivedOriginalData((byte[])msg.obj, width, height, pix_fmt, video_id,degree);
                    }
                    break;
                case ORG_VIDEO_DEGREE:
                    //Log.e("arsen", "DEGREE is arg1  " + msg.arg1+" arg2  "+msg.arg2);
                    break;
    ...
    private static void postEventFromNative(Object weakThiz, int what,
            int arg1, int arg2,int arg3,Object obj) {
        if (weakThiz == null)
            return;
        ...
        if (mp.mEventHandler != null) {
            if(what == ORG_VIDEO_STATE)
            {
                Message m = mp.mEventHandler.obtainMessage(what, arg1, arg3, obj);
