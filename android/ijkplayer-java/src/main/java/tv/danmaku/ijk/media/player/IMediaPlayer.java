...
public interface IMediaPlayer {
    ...
    void startInsertVideo(int width, int height, int pix_fmt) throws IllegalStateException;

    void insertVideoData(byte[] data, int align, boolean copy) throws IllegalStateException;

    void stopInsertVideo() throws IllegalStateException;

    void setOutputVideo(boolean enable) throws IllegalStateException;
    ...
    interface OnInsertVideoListener {
        void onInsertVideo(IMediaPlayer mp, int resultCode);
    }

    interface OnReceivedFrameListener {
        void onReceivedFrame(IMediaPlayer mp, byte[] data, int width, int height, int pixelFormat);
    }

    interface OnReceivedOriginalDataListener {
        void onReceivedOriginalData(IMediaPlayer mp, byte[] data, int width, int height, int pixelFormat, int videoId,int degree);
    }
